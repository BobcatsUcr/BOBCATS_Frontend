      ...
      <section className="py-10 bg-gray-100">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-center text-xl mb-12">
            Andá andá con Bobcats. Descubre nuestros productos y vive la
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-lg shadow-lg p-6 text-center h-90 flex flex-col transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl hover:border hover:border-gray-200">
              ...
              <div className="flex-grow flex flex-col justify-end">
                <p className="text-gray-600 text-lg">
                  Equipamiento y prendas para explorar el mundo natural con
                  estilo.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-lg shadow-lg p-6 text-center h-90 flex flex-col transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl hover:border hover:border-gray-200">
              ...
              <div className="flex-grow flex flex-col justify-end">
                <p className="text-gray-600 text-lg">
                  Nuestro equipo está aquí para apoyarte en cada paso de tu
                  aventura.
                </p>
              </div>
            </div>
